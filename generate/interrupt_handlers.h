/************************************************************************/
/*    File Version : V1.00C                                             */
/*    History  : 1.0  (2019-07-17)  [Hardware Manual Revision : 1.00]   */
/*    Date Modified: 02/10/2019                                         */
/************************************************************************/
...
// ICU GROUPIE0
void INT_Excep_ICU_GROUPIE0(void) __attribute__ ((interrupt));
...
// SSIE0 SSITXI0
void INT_Excep_SSIE0_SSITXI0(void) __attribute__ ((interrupt));

// SSIE0 SSIRXI0
void INT_Excep_SSIE0_SSIRXI0(void) __attribute__ ((interrupt));

// SSIE1 SSIRTI1
void INT_Excep_SSIE1_SSIRTI1(void) __attribute__ ((interrupt));
